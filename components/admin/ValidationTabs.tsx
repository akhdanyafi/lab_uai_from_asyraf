...
export default function ValidationTabs({ loansContent, roomsContent }: ValidationTabsProps) {
    const [activeTab, setActiveTab] = useState<'loans' | 'rooms'>('loans');
    ...
    return (
        <div>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
                {activeTab === 'loans' ? loansContent : roomsContent}
            </div>
        </div>
    );
}
