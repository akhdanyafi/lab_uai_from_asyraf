import { getGovernanceDocs, uploadGovernanceDoc, deleteGovernanceDoc } from '@/lib/actions/documents';
...
export default async function AdminDocumentsPage() {
    ...
    const governanceDocs = await getGovernanceDocs();

    return (
        <div>
            <div className="mb-6">
                <h1 className="text-2xl font-bold text-gray-900">Manajemen Dokumen</h1>
                <p className="text-gray-500 text-sm mt-1">Kelola dokumen tata kelola</p>
            </div>
